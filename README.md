...
- **Prévia de verdade:** o documento inteiro aparece numa coluna que rola, com a assinatura por cima. Dá para arrastar (até para outra página), redimensionar (também pelo teclado) ou tirar a assinatura dali. O que você vê é o que sai no PDF.
- **Acha o lugar sozinho, mesmo em 60 páginas:** lista todos os blocos de assinatura do documento (Contratante, Contratada, Testemunha 1…, com o nome de quem assina) e abre direto no seu. Um clique troca de lugar. Também dá para digitar o número da página, usar a régua de páginas na borda ou procurar um trecho do texto. Se não achar nada (PDF escaneado), você escolhe “Outro lugar” e clica na página.
- **Rubrica, local e data, vários lugares:** “Rubricar todas as páginas” põe a rubrica no canto de baixo de cada página (você desenha uma vez; arrastar numa página muda em todas). “Escrever local e data” escreve “São Paulo, 22 de setembro de 2026” perto da assinatura, com nome e CPF se quiser (a cidade, o nome e o CPF ficam guardados só no seu computador). “Assinar em mais um lugar” põe a mesma assinatura em outro ponto do documento com um clique. Tudo entra no PDF de uma vez, e a rubrica é gravada uma vez só no arquivo, que quase não cresce.
- **Comprovante:** um PDF à parte, ao lado da cópia assinada, com data e hora, onde foi assinado, a assinatura usada e o SHA-256 do original e do assinado, com o passo a passo para conferir. Ele diz o que é e o que não é: não é certificado digital e, sozinho, não identifica quem assinou.
- **Entrada e saída em toda etapa:** o canhoto à esquerda mostra o documento, onde assinar, a sua assinatura e o histórico. Dá para trocar ou remover o documento errado (o arquivo continua no computador), cancelar antes de assinar e desfazer depois: a cópia assinada vai para a Lixeira e o documento fica pronto para assinar de novo.
...
- **Registro de evidências:** para cada assinatura, grava a data e a hora e o SHA-256 do original e do assinado num log encadeado por hash. Desfazer entra no log também (nada é apagado dele).
- **Enviar ou guardar, pelo computador:** depois de assinar, o próprio labsign abre o PDF, mostra na pasta, salva uma cópia onde você escolher (janela do sistema) ou copia o arquivo para colar em qualquer lugar. No **Apple Mail** e no **Outlook**, abre uma mensagem nova já com o PDF anexado. No **Gmail** e no **WhatsApp** (que não aceitam anexo por link), abre a conversa ou a mensagem, deixa o PDF copiado e a pasta aberta ao lado: é só colar (⌘V) ou arrastar. Quem aperta Enviar é sempre você.
